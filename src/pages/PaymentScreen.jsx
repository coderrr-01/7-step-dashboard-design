...
export default function PaymentScreen() {
   ...
   // swap in real links whenever the socials go live. WhatsApp keeps its link.
   const iconLinkStyle = {
      border: 0,
      background: "none",
      padding: 0,
               ...
               <div className="row g-5">
                  ...
                  <aside className="col-lg-5 order-2 order-lg-1">
                     ...
                     <div className="merchant-footer text-center">
                        ...
                        <a
                           className="text-primary-container fw-bold small text-decoration-none d-flex align-items-center justify-content-center gap-2 mb-3"
                           role="button"
                           tabIndex={0}
                           onClick={(e) => {
                              e.preventDefault();
                              ...
                              // console.log("🟡 OPEN_SALESIQ message sent to parent");
                           }}
                        >
                           <span className="material-symbols-outlined fs-6">
                        ...
                        <div className="d-flex justify-content-center gap-3 opacity-50 payment-card-logos">
                           ...
                           {/* Facebook */}
                           <button type="button" aria-label="Facebook" style={iconLinkStyle} onClick={() => toast.info("Our Facebook page is coming soon.")}>
                              <svg
                           ...
                           {/* Twitter */}
                           <button type="button" aria-label="Twitter" style={iconLinkStyle} onClick={() => toast.info("Our Twitter page is coming soon.")}>
                              <svg
                                 xmlns="http://www.w3.org/2000/svg"
                                 width="20"
                                 height="20"
                           ...
                           {/* YouTube */}
                           <button type="button" aria-label="YouTube" style={iconLinkStyle} onClick={() => toast.info("Our YouTube channel is coming soon.")}>
                              <svg
                                 xmlns="http://www.w3.org/2000/svg"
                                 width="20"
                                 height="20"
                           ...
                           {/* Instagram */}
                           <button type="button" aria-label="Instagram" style={iconLinkStyle} onClick={() => toast.info("Our Instagram page is coming soon.")}>
                              <svg
                                 xmlns="http://www.w3.org/2000/svg"
                                 width="20"
                                 height="20"
