...
export default function Navigator({ activeStep = 1, totalSteps = 7, title }) {
  ...
  const getTimelineClass = (state) => {
    switch (state) {
      case "completed": return "timeline-item";
      case "active":    return "timeline-item timeline-item-active";
      case "inactive":  return "timeline-item timeline-item-inactive";
      case "muted":     return "timeline-item timeline-item-muted";
  ...
  const getBadgeClass = (state) => {
    switch (state) {
      case "completed": return "completed-badges";
      case "active":    return "active-badges";
      default:          return "upcoming-badges";
    }
  };
